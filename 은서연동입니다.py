...
mainMenu.add_cascade(label = "이미지 효과", menu = sizeMenu)
sizeMenu.add_command(label = "확대하기", command = func_zoom)
sizeMenu.add_separator()
sizeMenu.add_command(label = "축소하기", command = func_subsample)
